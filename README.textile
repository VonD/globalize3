...
h2. Options for the has_many association

If you want to pass further options to the has_many association that gets created, you can pass an @:association@ option to the @translates@ method.

<pre><code>translates :title, :content, :association => {:autosave => true}</code></pre>
